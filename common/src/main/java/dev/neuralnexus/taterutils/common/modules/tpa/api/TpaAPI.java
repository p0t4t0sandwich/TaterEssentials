...
public class TpaAPI {
  ...
  public static class TPRequest {
    ...
    public void sendExpireMessage() {
      sender.sendMessage(
          Utils.substituteSectionSign(
              "&aYour teleport request to &e" + receiver.getName() + " &ahas expired."));
    }
    ...
    public void accept() {
      ...
      sender.sendMessage(
          Utils.substituteSectionSign(
              "&aYou have accepted the teleport request from &e" + receiver.getName() + "&a."));
    ...
    public void deny() {
      sender.sendMessage(
          Utils.substituteSectionSign(
              "&aYou have denied the teleport request from &e" + receiver.getName() + "&a."));
      receiver.sendMessage(
          Utils.substituteSectionSign(
